...
namespace new_chess_server.Migrations
{
    ...
    [Migration("20250111153105_ReworkPracticeModeHistory")]
    partial class ReworkPracticeModeHistory
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("new_chess_server.Models.FriendRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("new_chess_server.Models.MoveHistoryItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("PracticeModeGameHistoryId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("PracticeModeGameHistoryId");

                    b.ToTable("MoveHistoryItems");
                });

            modelBuilder.Entity("new_chess_server.Models.PracticeModeGameHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("PracticeModeGameHistories");
                });
            ...
            modelBuilder.Entity("new_chess_server.Models.MoveHistoryItem", b =>
                {
                    b.HasOne("new_chess_server.Models.PracticeModeGameHistory", "practiceModeGameHistory")
                        .WithMany("Moves")
                        .HasForeignKey("PracticeModeGameHistoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("practiceModeGameHistory");
                });

            modelBuilder.Entity("new_chess_server.Models.PracticeModeGameHistory", b =>
                {
                    b.HasOne("new_chess_server.Models.User", "User")
                        .WithOne("PracticeModeGameHistory")
                        .HasForeignKey("new_chess_server.Models.PracticeModeGameHistory", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
